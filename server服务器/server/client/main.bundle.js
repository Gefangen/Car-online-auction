...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_12__shared_product_service__["b" /* ProductService */], __WEBPACK_IMPORTED_MODULE_15__shared_web_socket_service__["a" /* WebSocketService */],
                { provide: __WEBPACK_IMPORTED_MODULE_16__angular_common__["g" /* LocationStrategy */], useClass: __WEBPACK_IMPORTED_MODULE_16__angular_common__["d" /* HashLocationStrategy */] }],
...
module.exports = "<div class=\"container\">\n  <hr>\n  <footer>\n    <div class=\"row\">\n      <div class=\"col-lg-12\">\n        <p>版权所有ALL Right Reserved. ©[Development By Zhang Yaoqi]</p>\n      </div>\n    </div>\n  </footer>\n</div>\n"
...
var SearchComponent = /** @class */ (function () {
    function SearchComponent(productService) {
        ...
        this.formModel = fb.group({
            title: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].minLength(2)],
...
var WebSocketService = /** @class */ (function () {
    ...
    WebSocketService.prototype.createObservableSocket = function (url, id) {
        ...
        return new __WEBPACK_IMPORTED_MODULE_1_rxjs__["Observable"](function (observer) {
            ...
            _this.ws.onopen = function (event) { return _this.sendMessage({ productId: id }); }; //send的是一个对象
